...
Public Class connection
    ...
    Private connection As New MySqlConnection("Server=ww5211.mysql.database.azure.com;UserID = ww5211;Password=Aa1104558!;Database=gymdb;SslMode=Required;SslCa={path_to_CA_cert}")
